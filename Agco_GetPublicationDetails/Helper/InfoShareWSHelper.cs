...
namespace Agco_GetPublicationDetails.Helper
{
    public class InfoShareWSHelper
    {
        ...
        private void FindIssuerEndpoint()
        {
            ...
            else
            {
                //InfoshareSTS case
                //Repeat the endpoints extraction process for the STS endpoint
                var wsdlImporter = GetWsdlImporter(new Uri("https://agcodev01.sdlproducts.com/ISHSTS/issue/wstrust/mex".Replace("/mex", "?wsdl")));
                var issuerEndpoints = wsdlImporter.ImportAllEndpoints();
